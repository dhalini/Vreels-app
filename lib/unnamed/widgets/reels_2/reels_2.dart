...
class _ReelsPageState extends State<ReelsPage>
  ...
  Future<void> _loadVideos() async {
    try {
      ...
      final reelsDir = Directory('${dir.path}/Videos');
      if (await reelsDir.exists()) {
        final files = reelsDir.listSync().whereType<File>().toList();
        ...
        setState(() => _reelFiles.addAll(files));
      } else {
        debugPrint('Videos folder not found.');
      }
    } catch (e) {
  ...
  void _onPageChanged(int newIndex) {
    if (_videoControllers.isNotEmpty &&
        _currentPageIndex < _videoControllers.length) {
      _videoControllers[_currentPageIndex].pause();
    }
    if (newIndex < _videoControllers.length) {
    ...
    return GestureDetector(
      ...
      child: Stack(
        children: [
          ...
          Positioned.fill(
            child: _buildVideoWidget(chewieController),
          ),
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (_) =>
                                OthersProfilePage(username: "Sujith")));
                  },
                  child: const Text(
                    '@crochetKnight',
                    style: TextStyle(
                ...
                const Text(
                  'Check out my crocheted armor! #crochet #knight #armor',
